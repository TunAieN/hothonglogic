// Classic content-script module. It exposes one focused scraper API because
// Manifest V3 content scripts are not loaded as ES modules.
(() => {
...
globalThis.HothonglogicProductScraper = Object.freeze({ extractProductInfo });
})();
